...
def user_register_json():
    ...
    with open(file_name, 'w') as file:
        ...
        file.close()
        messagebox.showinfo(title='Registration Done',message=f'Registration done ,file mit Username {username}_data.json wird in jsonfile folder erstellet,bitte login Sie jetzt mit Ihre Username & Master Password ')
        messagebox.showinfo(title='Registration Done', command=user_login())#geht zum Login Screen
