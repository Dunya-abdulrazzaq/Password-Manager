...
path = 'G:\\pycham\\myproject\\Project'
...
def add_pwd_account():
    ...
    pass_choice = int(input('bitte wählen Sie ,Was von Password für diese Account möchten Sie ?,\n "1" eigene pasword  ,\n "2" Generated Komplex Password ,\n "3" encrepted Password \n >> '))
    if pass_choice == 1:
...
def get_data():
    ...
    with open(filename, 'r') as file:
        ...
        try:
            ...
            info_druck = int(input('diese Information wurde nicht gefounden ,wollen Sie alle Ihre gespeichert  login information drucken,bei ja geben Sie "1" or nein "2"\n>>'))
            if info_druck == 1:
                rahmen()
                print('\n')
                print(user_dict)
